...
const Footer = () => {
  return (
    <motion.div initial={{height:0}} whileInView={{height:'auto'}} transition={{duration:1}}
    ...
    <div className='grid md:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2 grid-cols-1 place-items-start gap-8 text-white'>
      <div>
         ...
         Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ab, esse sit. Tenetur harum eius nam deserunt beatae est! Deserunt, corrupti!
         </p>
        </div>
        <div>
